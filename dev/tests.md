...
https://www.youtube.com/watch?v=ttZSnuO-xXI

Одна временная дата указана

```
Последняя трансляция состоялась 102 минуты назад
11 июля в 12:00 (мск) приглашаем на вебинар, посвящённый промт-инжинирингу и применению больших языковых моделей (LLM) в бизнесе. Расскажем, как правильно составить запрос к языковой модели, чтобы бизнес получил максимум пользы. Вы узнаете о методах промт-инжиниринга, увидите эффективно работающие примеры запросов и познакомитесь с инструментами для создания приложений на основе YandexGPT.


На вебинаре обсудим:
* как промт-инжиниринг помогает увеличить пользу YandexGPT для решения бизнес-задач
* как формулировать запросы, чтобы получить наилучшие результаты
* какие особенности и ограничения LLM важно знать при создании промтов

Вебинар будет полезен всем, кто занимается разработкой собственных цифровых сервисов и хочет разобраться в основах и продвинутых методах промт-инжиниринга при работе с YandexGPT API.
```
